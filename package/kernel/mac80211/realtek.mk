PKG_DRIVERS += \
	...
	rtl8xxxu \
  rtw88 rtw88-pci rtw88-usb \
  rtw88-8822b rtw88-8822be rtw88-8822bu \
  rtw88-8822c rtw88-8822ce rtw88-8822cu \
  rtw88-8723d rtw88-8723de rtw88-8723du \
  rtw88-8821c rtw88-8821ce rtw88-8821cu
...
define KernelPackage/rtw88-pci
  $(call KernelPackage/mac80211/Default)
  TITLE:=Realtek RTW88 PCI support
...
define KernelPackage/rtw88-usb
  $(call KernelPackage/mac80211/Default)
  TITLE:=Realtek RTW88 USB support
...
define KernelPackage/rtw88-8822b
  $(call KernelPackage/mac80211/Default)
  TITLE:=Realtek RTW88 RTL8822BE/RTL8821BU common code
  DEPENDS+= +kmod-rtw88
...
define KernelPackage/rtw88-8822be
  $(call KernelPackage/mac80211/Default)
  TITLE:=Realtek RTW88 RTL8822BE support
...
define KernelPackage/rtw88-8822bu
  $(call KernelPackage/mac80211/Default)
  TITLE:=Realtek RTW88 RTL8822BU/RTL8821BU support
...
define KernelPackage/rtw88-8822c
  $(call KernelPackage/mac80211/Default)
  TITLE:=Realtek RTW88 RTL8822CE/RTL8822CU common code
  HIDDEN:=1
  DEPENDS+= +kmod-rtw88-pci
  FILES:=$(PKG_BUILD_DIR)/drivers/net/wireless/realtek/rtw88/rtw88_8822c.ko
endef

define KernelPackage/rtw88-8822ce
  $(call KernelPackage/mac80211/Default)
  TITLE:=Realtek RTW88 RTL8822CE support
...
define KernelPackage/rtw88-8822cu
  $(call KernelPackage/mac80211/Default)
  TITLE:=Realtek RTW88 RTL8822CU support
...
define KernelPackage/rtw88-8723d
  $(call KernelPackage/mac80211/Default)
  TITLE:=Realtek RTW88 RTL8723BE/RTL8723BU common code
  HIDDEN:=1
  DEPENDS+= +kmod-rtw88
...
define KernelPackage/rtw88-8723de
  $(call KernelPackage/mac80211/Default)
  TITLE:=Realtek RTW88 RTL8723DE support
...
define KernelPackage/rtw88-8723du
  $(call KernelPackage/mac80211/Default)
  TITLE:=Realtek RTW88 RTL8723DU support
...
define KernelPackage/rtw88-8821c
  $(call KernelPackage/mac80211/Default)
  TITLE:=Realtek RTW88 RTL8821CE/RTL8821CU common code
  HIDDEN:=1
  DEPENDS+= +kmod-rtw88
...
define KernelPackage/rtw88-8821ce
  $(call KernelPackage/mac80211/Default)
  TITLE:=Realtek RTW88 RTL8821CE support
...
define KernelPackage/rtw88-8821cu
  $(call KernelPackage/mac80211/Default)
  TITLE:=Realtek RTW88 RTL8821CU support
